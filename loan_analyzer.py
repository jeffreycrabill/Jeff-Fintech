...
amount_of_loans = len(loan_costs)
print(f"There are {amount_of_loans} loans")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
loan_total = sum(loan_costs)
print(f"The total amount of loans is ${loan_total}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan = loan_total / amount_of_loans
...
if present_value >= loan.get("loan_price"):
    print(f"The loan is worth buying at current price")
else:
    print("The loan is too expensive to buy at current price")
